...
export class NotificationsController {
  ...
  @ApiOperation({
    ...
    description:
      '🔒 Requires authentication. Returns paginated list of notifications with related post/comment info.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiResponse({
    status: 200,
    description:
      'Notifications retrieved successfully with pagination metadata',
  ...
  @ApiOperation({
    ...
    description:
      '🔒 Requires authentication. Returns count of unread notifications for the current user.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      '🔒 Requires authentication and ownership. Marks a single notification as read.',
  })
  ...
  @ApiOperation({
    ...
    description:
      '🔒 Requires authentication. Marks all user notifications as read.',
  })
  ...
  @ApiOperation({
    ...
    description:
      '🔒 Requires authentication and ownership. Permanently deletes a notification.',
  })
  @ApiParam({ name: 'id', description: 'Notification UUID', format: 'uuid' })
  @ApiResponse({
    status: 204,
